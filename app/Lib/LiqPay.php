<?php
    ...
    class LiqPay
    {
        ...
        public function getHashedJson($params)
        {
            $params = $this->cnb_params($params);
            $data = $this->encode_params($params);
            $signature = $this->cnb_signature($params);
            return json_encode(['params' => $params, 'purchaseDetails' => $data, 'signature' => $signature]);
        }

        public function getHashedJsonArray($params)
        {
            $params = $this->cnb_params($params);
            $data = $this->encode_params($params);
            $signature = $this->cnb_signature($params);
            return ['params' => $params, 'purchaseDetails' => $data, 'signature' => $signature];
        }
    }
