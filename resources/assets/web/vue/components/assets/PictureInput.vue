...
<script>
    export default {
        props: {
            ...
            buttonClass: {
                type: String,
                default: 'btn btn-fill-gray btn-large'
            },
            removeButtonClass: {
                type: String,
                default: 'btn btn-fill-red btn-large'
            },
            aspectButtonClass: {
                type: String,
        ...
        data () {
            return {
                ...
                canvasHeight: 0,
                strings: {
                    upload: '<p>Ваше устройство не поддерживается.</p>',
                    drag: 'Загрузить исходник',
                    tap: 'Загрузить исходник',
                    change: 'Изменить исходник',
                    aspect: 'Landscape/Portrait',
                    remove: 'Удалить',
                    select: 'Выбрать',
                    selected: '<p>Изображение успешно загружено</p>',
                    fileSize: 'Привышен лимит размера файла',
